(async function () {
  ...
  function setupDashboard() {
    ...
    section.insertAdjacentHTML('beforeend', `<div class="notice">
      ...
      <p id="adminMessage"></p>
    </div><div class="exam-grid" style="margin-top:20px"><a class="exam-card exam-card-link" href="manage-chapters.html"><div class="exam-card-body"><svg class="exam-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M4 4.5A2.5 2.5 0 016.5 2H20v20H6.5A2.5 2.5 0 014 19.5z"/><path d="M8 6h8M8 10h8"/></svg><h3>Chapter Modules</h3><p>Publish chapter modules to the class-wise AI and IT chapter pages.</p><span class="btn small">Click Here</span></div></a><a class="exam-card exam-card-link" href="manage-revision-papers.html"><div class="exam-card-body"><svg class="exam-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M5 4h14v16H5z"/><path d="M8 8h8M8 12h8M8 16h4"/></svg><h3>Revision Papers</h3><p>Publish rich-text revision tests with MCQs, Q&amp;A, and practice text.</p><span class="btn small">Click Here</span></div></a><a class="exam-card exam-card-link" href="quiz-results.html"><div class="exam-card-body"><svg class="exam-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg><h3>Quiz Results</h3><p>Review student quiz scores, filter by class and subject, and download Excel reports.</p><span class="btn small">Click Here</span></div></a><a class="exam-card exam-card-link" href="advertisements.html"><div class="exam-card-body"><svg class="exam-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M18 8a6 6 0 010 12m0-12A6 6 0 006 8m12 0v2a4 4 0 01-4 4m0 0a4 4 0 01-4-4m4 4v4"/></svg><h3>Homepage Advertisements</h3><p>Add and activate externally hosted poster images shown to homepage visitors.</p><span class="btn small">Click Here</span></div></a><a class="exam-card exam-card-link" href="contact-messages.html"><div class="exam-card-body"><svg class="exam-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg><h3>Contact Messages</h3><p>Read questions and feedback sent through the website.</p><span class="btn small">Click Here</span></div></a></div>`);
  }
